    ...
    <div className="pc-modal" role="dialog" aria-modal="true" aria-label={product.name}>
      ...
      <div className="pc-modal-panel">
        <header className="pc-modal-head">
          <div className="pc-modal-titleblock">
            <div className="pc-meta-row">
              ...
              {product.pageNumber ? (
                <span className="pc-page">p. {product.pageNumber}</span>
              ) : null}
            </div>
            <h2>{product.name}</h2>
        ...
        <div className="pc-modal-body">
          {product.imageUrl ? (
            <div className="pc-modal-hero" aria-hidden>
          ...
          <section className="pc-modal-section">
            ...
            {product.specs.length ? (
              ...
              <p className="pc-status">Specifications will appear after the next catalogue ingest.</p>
            )}
          </section>
